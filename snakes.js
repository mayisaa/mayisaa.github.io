    ...
    snake.game = (function()
    {
        ...
        function draw(pos)
        {
            ...
            if(x >= canvas.width || x <= 0 || y >= canvas.height || y<= 0)
            {
                    ...
                    ctx.fillText('To Play again click the Restarts button or Refresh the page.',200,300);
                    throw ('Game Over');
            }
            else
            {
        ...
        function start()
        {
            ...
            ctx.fillText('Not the Button!',300,140);
            ctx.font='20px san-serif';
            ctx.fillText('presents',395,190);
            ctx.font='italic 60px san-serif';
            ctx.fillText('Feed The Snake, by Vingesh',100,280);
            var img = new Image();
            img.onload = function()
            {
